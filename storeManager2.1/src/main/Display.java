...
public class Display {
    ...
    public static void printBillC(Bill bill) {
    ...
    public static String printBill(Bill bill) {
        ...
        String s = "";
        s += "***********************************************" + "\n";
        s += "* ID: " + bill.getIdBill() + "\t\tTime: " + bill.getTime() + "\t" + bill.getDate() + "\n";
        s += "* Employee: " + bill.getEmployee() + "\n";
        s += "*| Stt\t| Ten SP\t\t| SL\t| gia\t| CK\t| TT\t" + "\n";
        for (int i = 0; i < bill_details.size(); i++) {
            s += "*| " + (i+1) + "\t" + bill_details.get(i).toString() + "\n";
        }
        s += "*                                               " + "\n";
        s += "*\t\t\t\t\t\tTong: " + bill.getSum() + "\n";
        s += "*                                               " + "\n";
